...
apt-get install openjdk-7-jre-headless wget unzip nano ntpdate
...
## Setup apache and tomcat7 directories
#Create a /var/www directory if it's not already there
mkdir /var/www
